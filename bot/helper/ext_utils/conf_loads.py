...
default_values = {'AUTO_DELETE_MESSAGE_DURATION': 30,
                  ...
                  'CHANNEL_USERNAME': 'https://t.me/aiousr',
                  'AUTHOR_NAME': 'No Name',
                  'AUTHOR_URL': 'https://t.me/R4ndomUsr',
                  ...
                  'COMPRESS_BANNER': 'Re-Endoced by @AIOReleases',
                  'LIB264_PRESET': 'superfast',
                  'LIB265_PRESET': 'faster',
                  'HARDSUB_FONT_NAME': 'AIOReleases',
...
async def load_config():
    ...
    HARDSUB_FONT_NAME = environ.get('HARDSUB_FONT_NAME', 'AIOReleases')
    ...
    CHANNEL_USERNAME = environ.get('CHANNEL_USERNAME', 'mltb_official_channel')
    # ======================================================================
    ...
    AUTHOR_URL = environ.get('AUTHOR_URL', 'https://t.me/R4ndomUsr')
    DRIVE_SEARCH_TITLE = environ.get('DRIVE_SEARCH_TITLE', 'Drive Search')
    GD_INFO = environ.get('GD_INFO', 'By @aiousr')
