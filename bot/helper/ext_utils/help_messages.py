...
Example: <code>{escape("<b>By:</b> <a href='https://t.me/aiousr'>No Name</a>")}</code>
Result: <b>By:</b> <a href='https://t.me/aiousr'>No Name</a>\n
...
Send metadata title for video file like <b>Uploaded by @AIOREleases</b>
<b>Current:</b> <code>{}</code>\n
<i>Timeout: 60s.</i>
'''
